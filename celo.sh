sudo apt update
sudo apt install apt-transport-https ca-certificates curl software-properties-common python npm 
...
geth account new
export CELO_ACCOUNT_ADDRESS=e741722652bca8870c4ea15bf11aa1990fff266e
echo "export CELO_ACCOUNT_ADDRESS=e741722652bca8870c4ea15bf11aa1990fff266e" >> ~/.bashrc
...
#start node
docker run -d -p 127.0.0.1:8545:8545 -p 127.0.0.1:8546:8546 -p 30303:30303 -p 30303:30303/udp -v `pwd`:/root/.celo us.gcr.io/celo-testnet/celo-node:alfajores --verbosity 3 --networkid 44785 --syncmode full --rpc --rpcaddr 0.0.0.0 --rpcapi eth,net,web3,debug,admin,personal --lightserv 90 --lightpeers 1000 --maxpeers 1100 --etherbase $CELO_ACCOUNT_ADDRESS
